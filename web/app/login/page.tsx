      ...
      <div className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-lg bg-indigo-600 px-4 py-2 text-sm font-semibold text-white [transition:background-color_150ms_ease-out,transform_100ms_ease-out] hover:bg-indigo-700 active:scale-[0.97] focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed"
          >
